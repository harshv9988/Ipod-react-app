...
const Screen = (props) =>{
    const {coverflow, music, games, setting, musiclist, artist, songs, musicscreen, coverflowscreen, gamesscreen, settingscreen} = props;
    return (
        <div className={`${musicscreen || coverflowscreen || gamesscreen || settingscreen ? "hide" : "screen"}`}>
